...
# Copilot Coding Agent Instructions for Poscally
...
- SDK (`apps/sdk`) provides programmatic access to Poscally features.
...
## Documentation
- Main docs: https://docs.poscally.com/
- Developer guide: https://docs.poscally.com/developer-guide
- Public API: https://docs.poscally.com/public-api
