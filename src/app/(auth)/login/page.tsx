...
export default function LoginPage() {
  return (
    <div className="w-full max-w-[380px] rounded-[28px] border border-border bg-white p-8 shadow-[0_30px_80px_-30px_rgba(20,20,40,0.18)]">
      <h1 className="text-center text-[22px] font-semibold tracking-tight text-foreground">Welcome back.</h1>
      ...
      <form className="mt-7 space-y-3">
        ...
        <div className="text-right">
          <Link href="/login" className="text-[12.5px] font-medium text-primary">
            Forgot password?
          </Link>
        </div>
        <button
