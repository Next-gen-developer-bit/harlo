...
import { isMvpPlatform } from '@gitroom/frontend/components/launches/helpers/mvp.platforms';
    ...
    <div className="flex flex-col gap-[16px] pt-[8px]">
      <p className="text-[14px] text-textColor/80">
        {t(
          ...
          'The Harlo Social browser extension is not installed. You need to install it before connecting this channel.'
        )}
      </p>
      <div className="flex gap-[10px]">
        <Button
          ...
          onClick={() => {
            window.open(
              'https://chromewebstore.google.com/detail/poscally/cidhffagahknaeodkplfbcpfeielnkjl?hl=en',
              '_blank'
            );
            modals.closeCurrent();
          }}
  ...
  return (
    <div className="flex flex-col gap-[16px] pt-[8px]">
      ...
      <ul className="flex flex-col gap-[8px] list-disc ps-[20px] text-[14px] text-textColor/80">
        ...
        <li>
          Harlo Social does not take responsibility for any issues arising or account
    ...
    (
      ...
      async () => {
        ...
        const gotoIntegration = async (externalUrl?: string) => {
          ...
          // carry the `poscally://` deep link so the backend redirects
          ...
          const params = [
            ...
            onboardingParam,
            isMobile
              ? `redirectUrl=${encodeURIComponent('poscally://integrations')}`
              : '',
          ]
            .filter(Boolean)
            .join('&');
          ...
          if (isMobile) {
            ...
            // app via `poscally://` once OAuth completes.
          ...
          try {
            ...
            toaster.show(
              t(
                ...
                'Harlo Social browser extension is not installed or not reachable.'
              ),
              'warning'
            );
            return;
  ...
  return (
    <div className="w-full flex flex-col gap-[20px] rounded-[4px] relative]">
      <div className="flex flex-col">
        ...
        >
          {social
            .filter((item) => isMvpPlatform(item.identifier))
            .filter((item) => {
              if (!props.invite) {
                return true;
              }
