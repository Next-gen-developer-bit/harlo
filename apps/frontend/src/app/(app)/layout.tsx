    ...
    <html>
      ...
      >
        <VariableContextComponent
          storageProvider={
            process.env.STORAGE_PROVIDER! as
              | 'local'
              | 'cloudflare'
              | 'supabase'
          }
          ...
          genericOauth={!!process.env.POSCALLY_GENERIC_OAUTH}
          oauthLogoUrl={process.env.NEXT_PUBLIC_POSCALLY_OAUTH_LOGO_URL!}
          oauthDisplayName={process.env.NEXT_PUBLIC_POSCALLY_OAUTH_DISPLAY_NAME!}
        ...
        >
          <SentryComponent>
            ...
            <Plausible
              domain={!!process.env.IS_GENERAL ? 'poscally.com' : ''}
            >
              <PHProvider
