...
export class PostsController {
  ...
  @Get('/overview')
  getWorkspaceOverview(@GetOrgFromRequest() org: Organization) {
    return this._postsService.getWorkspaceOverview(org.id);
  }
  ...
  retryFailedPost(
    ...
    return this._postsService.retryFailedPost(org.id, id);
  }
