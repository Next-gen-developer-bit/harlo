...
// Only use Redis-backed throttler storage when REDIS_URL is configured.
// Without this guard, ThrottlerStorageRedisService tries to connect to
// localhost:6379 even when a MockRedis is provided, causing ECONNREFUSED.
