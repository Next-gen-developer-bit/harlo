...
Posts cannot be deleted through the Poscally tools - if the user wants to delete a post, tell them to do it themselves in the Poscally app; never offer to delete a post.
`,
